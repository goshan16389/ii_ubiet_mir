...
## Результаты
Модель N-BEATS была обучена на 50 эпохах и показала отличные результаты, обогнав классический baseline ARIMA(1,1,1) по средней ошибке на всём наборе данных.
